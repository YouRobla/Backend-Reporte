...
export class MetricasController {
    ...
    static async getMetricasGenerales(_req, res) {
        try {
    ...
    static async getMetricasPorPeriodo(req, res) {
        try {
    ...
    static async getMetricasPorTipo(_req, res) {
        try {
    ...
    static async getMetricasRendimiento(_req, res) {
        try {
            const reportes = await ReporteModel.findAll(1, 1000);
