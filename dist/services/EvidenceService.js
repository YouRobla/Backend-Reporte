...
export class EvidenceService {
    // Subir una evidencia
    static async uploadEvidence(file, reporteId, accionId) {
    ...
    static async uploadMultipleEvidences(files, reporteId, accionId) {
        const folder = `${CLOUDINARY_FOLDERS.EVIDENCIAS}`;
    ...
    static async getEvidencesByReporte(reporteId) {
    ...
    static async getEvidencesByAccion(accionId) {
