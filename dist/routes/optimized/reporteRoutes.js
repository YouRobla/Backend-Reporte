...
reporteRoutes.post("/completo", UploadFactory.getReportesUpload().array('evidencias', 10), UploadErrorHandler.handle, ReporteController.createReporteConEvidencias);
...
reporteRoutes.post("/:reporteId/evidencias", UploadFactory.getReportesUpload().array('evidencias', 10), UploadErrorHandler.handle, ReporteController.agregarEvidenciasAReporte);
