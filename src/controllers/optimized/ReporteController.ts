...
export class ReporteController {
  ...
  static async createReporteConEvidencias(req: Request, res: Response) {
    try {
  ...
  static async agregarEvidenciasAReporte(req: Request, res: Response) {
    try {
  ...
  static async createReporteBasico(req: Request, res: Response) {
    try {
  ...
  static async getByEstado(req: Request, res: Response) {
    try {
