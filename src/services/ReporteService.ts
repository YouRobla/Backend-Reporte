...
export class ReporteService {
  ...
  static async createReporteConEvidencias(
    reporteData: any, 
    files?: Express.Multer.File[]
  ): Promise<ReporteWithEvidencias> {
  ...
  static async agregarEvidenciasAReporte(
    reporteId: number, 
    files: Express.Multer.File[]
  ): Promise<ReporteWithEvidencias> {
  ...
  static async createReporteBasico(reporteData: any) {
    const validatedData = ReporteValidator.validateCreate(reporteData);
    const reporte = await ReporteModel.create(validatedData);
  ...
  static async getReporteById(id: number) {
  ...
  static async getReportesByEstado(estado: string) {
  ...
  // Actualizar reporte
  static async updateReporte(id: number, data: any) {
  ...
  // Eliminar reporte
  static async deleteReporte(id: number) {
    const reporte = await ReporteModel.findById(id);
    if (!reporte) {
